...
from search_space import Operation, INPUT_DIM
import search_space
...
def _get_image_size_in_last_stack() -> int:
    ...
    """
    return int(INPUT_DIM * pow(0.5, search_space.STACK_COUNT - 1))
...
def _get_number_of_output_filters() -> int:
    ...
    """
    return search_space.NUMBER_OF_FILTERS * search_space.STACK_COUNT
